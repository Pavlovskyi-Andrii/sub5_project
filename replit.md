...
## Последние изменения
- **09.10.2025**: Создан основной скрипт синхронизации
  - Реализована авторизация в Garmin Connect с кешированием сессии
  - Добавлена интеграция с Google Sheets через Service Account
  - Реализована синхронизация велосипедных тренировок
  - Реализована синхронизация беговых тренировок
  - Добавлено форматирование данных (темп, время)
  - Созданы примеры конфигурации и документация
  - Добавлена защита от дубликатов по ActivityID
  - Улучшена обработка ошибок с понятными сообщениями на русском
